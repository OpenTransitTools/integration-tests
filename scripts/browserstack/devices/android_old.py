...
tablets = [
  {'name': 'androidGalaxyTabChrome', 'device': 'Samsung Galaxy Tab S6', 'browser': 'Chrome', 'browserVersion': 'latest', 'os': 'android', 'osVersion': '9.0', 'orientation': 'portrait'},
  {'name': 'androidGalaxyTabUc',     'device': 'Samsung Galaxy Tab S6', 'browser': 'UC Browser', 'browserVersion': 'latest', 'os': 'android', 'osVersion': '9.0', 'orientation': 'portrait'},
  {'name': 'androidGalaxyTabSam',    'device': 'Samsung Galaxy Tab S6', 'browser': 'Samsung Internet', 'browserVersion': 'latest', 'os': 'android', 'osVersion': '9.0', 'orientation': 'portrait'},
]
